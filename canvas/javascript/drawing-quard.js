class DrawingQuard extends PaintFunction {
  ...
  onMouseDown(coord, event) {
    ...
    if (this.clickCount == 1) {
      ...
      this.contextDraft.font =
        $("#text-size").val() + "px" + " " + "Arial" + " " + "blue";
    ...
    if (this.clickCount == 3) {
      ...
      this.contextDraft.font =
        $("#text-size").val() + "px" + " " + "Arial" + " " + "blue";
      this.contextDraft.textAlign = "center";
      this.contextDraft.fillText("Third Point", this.thirdX, this.thirdY - 10);

      this.contextDraft.fillText("Locate the fourth point!!", 1280 / 2, 700);

      this.contextDraft.strokeStyle = userColor;
      this.contextDraft.lineWidth = lineWidth;
      this.contextDraft.beginPath();
      this.contextDraft.arc(this.thirdX, this.thirdY, 10, 0, 2 * Math.PI);
      this.contextDraft.stroke();

      this.contextDraft.beginPath();
      this.contextDraft.moveTo(this.endX, this.endY);
